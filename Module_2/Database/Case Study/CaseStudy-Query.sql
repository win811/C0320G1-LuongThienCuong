...
DROP TEMPORARY TABLE IF EXISTS months_in_year2019;
...
#Câu 15---------------------------------------------------------------------------------------------------- E-L
SELECT employee_id,employee_name,edu_degree,division_name,employee_phone,employee_address, count(*) AS amount_contract
FROM contracts
	JOIN employees USING(employee_id)
